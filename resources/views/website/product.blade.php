...
<head>
    ...
    <title>Laxour Aura - Product Details</title>
    <!-- Tailwind CSS CDN -->
...
<body class="antialiased">
    ...
    <!-- Header (consistent with landing and shop pages) -->
    <header class="bg-white shadow-sm py-4 px-6 md:px-12 fixed top-0 left-0 w-full z-50 rounded-b-lg">
        <nav class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="shop.html" class="text-indigo-600 font-medium transition-colors duration-300">Models</a> <!-- Active link for this page, linking to shop -->
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 space-y-2">
            ...
            <a href="shop.html" class="block text-indigo-600 font-medium py-2 px-4 rounded-md transition-colors duration-300">Models</a>
    ...
    <main class="pt-28 pb-20">
        <section class="container mx-auto px-6 md:px-12">
            <div class="flex flex-col lg:flex-row gap-10 bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="lg:w-1/2">
                    <img src="https://placehold.co/800x500/e0e7ff/4338ca?text=Laxour+Aura+Front" alt="Laxour Aura Front View" class="w-full h-auto rounded-lg shadow-md mb-4 object-cover">
                    <div class="grid grid-cols-4 gap-4">
                        <img src="https://placehold.co/200x120/e0e7ff/4338ca?text=Side" alt="Laxour Aura Side View" class="w-full h-24 object-cover rounded-md cursor-pointer hover:opacity-80 transition-opacity duration-200">
                        <img src="https://placehold.co/200x120/e0e7ff/4338ca?text=Interior" alt="Laxour Aura Interior" class="w-full h-24 object-cover rounded-md cursor-pointer hover:opacity-80 transition-opacity duration-200">
                        <img src="https://placehold.co/200x120/e0e7ff/4338ca?text=Rear" alt="Laxour Aura Rear View" class="w-full h-24 object-cover rounded-md cursor-pointer hover:opacity-80 transition-opacity duration-200">
                        <img src="https://placehold.co/200x120/e0e7ff/4338ca?text=Dashboard" alt="Laxour Aura Dashboard" class="w-full h-24 object-cover rounded-md cursor-pointer hover:opacity-80 transition-opacity duration-200">
                    </div>
                </div>
                ...
                <div class="lg:w-1/2">
                    ...
                    <p class="text-xl text-gray-700 mb-6">The epitome of elegance and efficiency, designed for the discerning urban driver.</p>
                    ...
                    <p class="text-gray-800 leading-relaxed mb-8">
                        The Laxour Aura redefines urban mobility with its sophisticated design, advanced technology, and eco-friendly performance. Engineered for a smooth and responsive drive, it offers unmatched comfort and connectivity, making every journey a pleasure. Its compact yet spacious interior is crafted with premium materials, ensuring a luxurious experience for both driver and passengers.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700 mb-8">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-indigo-600 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button class="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                            Configure Your Aura
                        </button>
                        <button class="flex-1 border border-gray-300 text-gray-800 hover:bg-gray-50 font-bold py-3 px-8 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
    ...
    <!-- Footer (consistent with landing and shop pages) -->
